...
<div class="wprc-copy-link">
	<div class="input-group" dir="rtl">
		<span class="input-group-button">
			<button class="btn-copy" data-clipboard-text="<?php echo esc_url($new_url); ?>">
				<svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 115.77 122.88" xml:space="preserve">
					<style type="text/css">
						.st0 {
							fill-rule: evenodd;
							clip-rule: evenodd;
